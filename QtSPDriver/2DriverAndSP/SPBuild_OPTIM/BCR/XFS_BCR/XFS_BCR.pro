...
# IDC命令系
contains(DEFINES, CMD_BCR_IDC) {
    SOURCES += \
            XFS_BCR_IDC/XFS_BCR_IDC.cpp \
            XFS_BCR_IDC/XFS_BCR_IDC_DEC.cpp \
            XFS_BCR_IDC/XFS_BCR_IDC_FIRE.cpp

    HEADERS += \
            XFS_BCR_IDC/XFS_BCR_IDC.h \
            IDevBCR.h \
            ISPBaseIDC.h
} else {
# BCR命令系
    SOURCES += \
            XFS_BCR/XFS_BCR.cpp \
            XFS_BCR/XFS_BCR_DEC.cpp \
            XFS_BCR/XFS_BCR_FIRE.cpp
