...
// 0~100: 硬件设备返回
#define IMP_ERR_DEVRET_00           -1000 - 1       // 命令编码未定义
#define IMP_ERR_DEVRET_01           -1000 - 2       // 命令参数错误
#define IMP_ERR_DEVRET_02           -1000 - 3       // 命令无法执行
#define IMP_ERR_DEVRET_03           -1000 - 4       // 硬件不支持
#define IMP_ERR_DEVRET_04           -1000 - 5       // 命令数据错误
#define IMP_ERR_DEVRET_05           -1000 - 6       // IC触点未释放
#define IMP_ERR_DEVRET_06           -1000 - 7       // 密钥不存在
#define IMP_ERR_DEVRET_07           -1000 - 8       //
#define IMP_ERR_DEVRET_08           -1000 - 9       //
#define IMP_ERR_DEVRET_09           -1000 - 10      //
#define IMP_ERR_DEVRET_10           -1000 - 11      // 卡堵塞
#define IMP_ERR_DEVRET_11           -1000 - 12      // Shutter错误
#define IMP_ERR_DEVRET_12           -1000 - 13      // 传感器错误
#define IMP_ERR_DEVRET_13           -1000 - 14      // 不规则卡长度(过长)
#define IMP_ERR_DEVRET_14           -1000 - 15      // 不规则卡长度(过短)
#define IMP_ERR_DEVRET_15           -1000 - 16      // FRAM错误
#define IMP_ERR_DEVRET_16           -1000 - 17      // 卡位置移动
#define IMP_ERR_DEVRET_17           -1000 - 18      // 重进卡时卡堵塞
#define IMP_ERR_DEVRET_18           -1000 - 19      // SW1,SW2错误
#define IMP_ERR_DEVRET_19           -1000 - 20      // 卡没有从后端插入
#define IMP_ERR_DEVRET_20           -1000 - 21      // 读磁卡错误(奇偶校验错)
#define IMP_ERR_DEVRET_21           -1000 - 22      // 读磁卡错误
#define IMP_ERR_DEVRET_22           -1000 - 23      // 写磁卡错误
#define IMP_ERR_DEVRET_23           -1000 - 24      // 读磁卡错误(没有数据内容,只有STX起始符,ETX结束符和LRC)
#define IMP_ERR_DEVRET_24           -1000 - 25      // 读磁卡错误(没有磁条或没有编码-空白轨道)
#define IMP_ERR_DEVRET_25           -1000 - 26      // 写磁卡校验错误(品质错误)
#define IMP_ERR_DEVRET_26           -1000 - 27      // 读磁卡错误(没有SS)
#define IMP_ERR_DEVRET_27           -1000 - 28      // 读磁卡错误(没有ES)
#define IMP_ERR_DEVRET_28           -1000 - 29      // 读磁卡错误(LRC错误)
#define IMP_ERR_DEVRET_29           -1000 - 30      // 写磁卡校验错误(数据不一致)
#define IMP_ERR_DEVRET_30           -1000 - 31      // 电源掉电
#define IMP_ERR_DEVRET_31           -1000 - 32      // DSR信号为OFF
#define IMP_ERR_DEVRET_32           -1000 - 33      //
#define IMP_ERR_DEVRET_40           -1000 - 34      // 吞卡时卡拔走
#define IMP_ERR_DEVRET_41           -1000 - 35      // IC触点或触点传感器错误
#define IMP_ERR_DEVRET_42           -1000 - 36      //
#define IMP_ERR_DEVRET_43           -1000 - 37      // 无法走到IC卡位
#define IMP_ERR_DEVRET_44           -1000 - 38      //
#define IMP_ERR_DEVRET_45           -1000 - 39      // 卡机强制弹卡
#define IMP_ERR_DEVRET_46           -1000 - 40      // 前端卡未在指定时间内取走
#define IMP_ERR_DEVRET_47           -1000 - 41      //
#define IMP_ERR_DEVRET_48           -1000 - 42      //
#define IMP_ERR_DEVRET_49           -1000 - 43      //
#define IMP_ERR_DEVRET_50           -1000 - 44      // 回收卡计数溢出
#define IMP_ERR_DEVRET_51           -1000 - 45      // 马达错误
#define IMP_ERR_DEVRET_52           -1000 - 46      //
#define IMP_ERR_DEVRET_53           -1000 - 47      // 数字解码读错误
#define IMP_ERR_DEVRET_54           -1000 - 48      // 防盗钩移动错误
#define IMP_ERR_DEVRET_55           -1000 - 49      // 防盗钩已经设置,命令不能执行
#define IMP_ERR_DEVRET_56           -1000 - 50      // 芯片检测传感器错误
#define IMP_ERR_DEVRET_57           -1000 - 51      //
#define IMP_ERR_DEVRET_58           -1000 - 52      // 防盗钩正在移动
#define IMP_ERR_DEVRET_59           -1000 - 53      //
#define IMP_ERR_DEVRET_60           -1000 - 54      // IC卡或SAM卡Vcc条件异常
#define IMP_ERR_DEVRET_61           -1000 - 55      // IC卡或SAM卡ATR通讯错误
#define IMP_ERR_DEVRET_62           -1000 - 56      // IC卡或SAM卡在当前激活条件下ATR无效
#define IMP_ERR_DEVRET_63           -1000 - 57      // IC卡或SAM卡通讯过程中无响应
#define IMP_ERR_DEVRET_64           -1000 - 58      // IC卡或SAM卡通讯错误(除无响应外)
#define IMP_ERR_DEVRET_65           -1000 - 59      // IC卡或SAM卡未激活
#define IMP_ERR_DEVRET_66           -1000 - 60      // IC卡或SAM卡不支持(仅对于非EMV激活)
#define IMP_ERR_DEVRET_67           -1000 - 61      //
#define IMP_ERR_DEVRET_68           -1000 - 62      //
#define IMP_ERR_DEVRET_69           -1000 - 63      // IC卡或SAM卡不支持(仅对于EMV激活)
#define IMP_ERR_DEVRET_76           -1000 - 64      // ESU模块和卡机通讯错误
#define IMP_ERR_DEVRET_95           -1000 - 65      // ESU模块损坏或无连接
#define IMP_ERR_DEVRET_99           -1000 - 66      // ESU模块过流
#define IMP_ERR_DEVRET_B0           -1000 - 67      // 未接收到初始化命令
