...
#define DEV_STAT_RET_HWERR(DSTAT) \
    ...
    { \
        ...
        switch(DSTAT) \
        { \
            case WFS_IDC_DEVOFFLINE: SetErrorDetail(1, (LPSTR)EC_XFS_DevOffLine); break; \
            case WFS_IDC_DEVNODEVICE: SetErrorDetail(1, (LPSTR)EC_XFS_DevNotFound); break; \
            case WFS_IDC_DEVHWERROR: SetErrorDetail(1, (LPSTR)EC_XFS_DevHWErr); break; \
            case WFS_IDC_DEVPOWEROFF: SetErrorDetail(1, (LPSTR)EC_XFS_DevPowerOff); break; \
            case WFS_IDC_DEVUSERERROR: SetErrorDetail(1, (LPSTR)EC_XFS_DevUserErr); break; \
            case WFS_IDC_DEVFRAUDATTEMPT: SetErrorDetail(1, (LPSTR)EC_XFS_DevFraud); break; \
        } \
...
#define CHK_MEDIA_NOHAVE_RET(m) \
    ...
    { \
        ...
        SetErrorDetail(1, (LPSTR)EC_XFS_MedNotFound); \
...
#define CHK_MEDIA_ISJAM(m) \
    ...
    { \
        ...
        SetErrorDetail(1, (LPSTR)EC_XFS_MedJammed); \
...
#define CHK_RETAIN_ISFULL(m) \
    ...
    { \
        ...
        SetErrorDetail(1, (LPSTR)EC_XFS_BoxFull); \
