...
#include <QtTypeDef.h>                      // 30-00-00-00(FT#0067)

// 用于声明 XFS_XXX 与 DevXXX 共用的变量定义

//----------宏定义----------------------------------------------------

static const BYTE byXFSVRTU[17] = {"PTR00010100"};      // XFS_PTR 版本号
...
#define SET_BLACK_MOVE          52              // 设置黑标偏移
#define SET_DEV_RECON           53              // 设置断线重连标记
#define SET_DEV_OPENMODE        54              // 设备打开模式       // 30-00-00-00(FT#0067)
#define SET_DEV_PRTMODE         55              // 设置设备的打印模式
#define SET_DEV_LINEFEED        56              // 打印换行
#define SET_DEV_ROWHEIGHT       57              // 设置行高
...
// 设备打印模式
#define PRT_MODE_LINE           0               // 行模式
#define PRT_MODE_PAGE           1               // 页模式

// 打印字体格式
#define PRT_FONT_MODE_DEF       0               // 缺省
#define PRT_FONT_MODE_TRUETYPE  1               // TrueType模式
