...
static const BYTE byXFSVRTU[17] = {"CSR00010100"};      // XFS_CSR 版本号
static const BYTE byDevVRTU[17] = {"Dev010100"};        // DevPTR 版本号

// 设备类型(票据售卖模块)
#define IDEVCSR_TYPE_RSCD400M      "RSCD400M"       // 新北洋RSC-D400M票据打印机
#define IXFSCSR_TYPE_RSCD400M      0                // 新北洋RSC-D400M票据打印机

// 设备型号与程序内编号对应 定义
#define DEVTYPE_CHG(n)      (n == IXFSCSR_TYPE_RSCD400M ? IDEVCSR_TYPE_RSCD400M : "")
