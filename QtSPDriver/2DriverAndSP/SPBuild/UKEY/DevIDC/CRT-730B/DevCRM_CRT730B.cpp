...
long CDevCAM_TCF261::TakePictureEx(LPSTR lpFileName, LPCSTR lpCamData, WORD wPicType, bool isContinue, WORD wTimeOut)
{
    ...
    while(1)
    {
        ...
        if (wTimeCount >= wTimeOut * 1000 && m_devTCF261.GetTakePicStop() != TRUE)
        {
