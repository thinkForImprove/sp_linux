...
* 文件版本：1.0.0.1
****************************************************************/
#ifndef DEVIMPL_ACTU6SG5_H
#define DEVIMPL_ACTU6SG5_H
...
// 无分类　宏定义
*************************************************************/
#define LOG_NAME                    "DevImpl_ACTU6SG5.log"   // 缺省日志名
...
#define S_CMD_MOVE_BOX1_SCAN1       "C2"    // 移动操作:箱1UKEY到扫描位1
#define S_CMD_MOVE_BOX2_SCAN2       "C3"    // 移动操作:箱2UKEY到扫描位1
...
// 封装类: 命令编辑、发送接收等处理。
*************************************************************/
class CDevImpl_ACTU6SG5 : public CLogManage
{
public:
    CDevImpl_ACTU6SG5();
    CDevImpl_ACTU6SG5(LPSTR lpLog);
    virtual ~CDevImpl_ACTU6SG5();
    void Init();
