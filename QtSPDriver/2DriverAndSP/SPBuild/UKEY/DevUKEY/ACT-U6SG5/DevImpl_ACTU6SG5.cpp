...
* 文件版本：1.0.0.1
****************************************************************/
#include "DevImpl_ACTU6SG5.h"

static const char *ThisModule = "DevImpl_ACTU6SG5.cpp";

CDevImpl_ACTU6SG5::CDevImpl_ACTU6SG5()
{
    SetLogFile(LOG_NAME, ThisModule);  // 设置日志文件名和错误发生的文件
    Init();
}

CDevImpl_ACTU6SG5::CDevImpl_ACTU6SG5(LPSTR lpLog)
{
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::DeviceOpen(LPSTR lpMode)
{
    ...
    if (m_pDev == nullptr)
    {
        if (m_pDev.Load("AllDevPort.dll", "CreateIAllDevPort", "CRD", "DevCRD_ACTU6SG5") != 0)
        {
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::DeviceClose()
{
    THISMODULE(__FUNCTION__);
    AutoLogFuncBeginEnd();
    //AutoMutex(m_MutexAction);
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::Release()
{
    return DeviceClose();
}

BOOL CDevImpl_ACTU6SG5::IsDeviceOpen()
{
 ...
 * 返回值: 无
************************************************************/
void CDevImpl_ACTU6SG5::SetTimeOut(UINT uiSndTimeOut, UINT uiRcvTimeOut)
{
    if (uiSndTimeOut > 0)
    {
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::DeviceReset(USHORT usMode)
{
    THISMODULE(__FUNCTION__);
    AutoLogFuncBeginEnd();
    //AutoMutex(m_MutexAction);
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::GetDeviceStat(USHORT usMode, INT nStat[12])
{
    THISMODULE(__FUNCTION__);
    //AutoLogFuncBeginEnd();
    AutoMutex(m_MutexAction);
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::MoveMedia(USHORT usMode)
{
    THISMODULE(__FUNCTION__);
    AutoLogFuncBeginEnd();
    //AutoMutex(m_MutexAction);
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::ScanMedia(USHORT usMode, LPSTR lpRcvData, LPINT lpRcvDataLen)
{
    THISMODULE(__FUNCTION__);
    AutoLogFuncBeginEnd();
    //AutoMutex(m_MutexAction);
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::SetDeviceParam(USHORT usMode, INT nParam[12])
{
    THISMODULE(__FUNCTION__);
    AutoLogFuncBeginEnd();
    //AutoMutex(m_MutexAction);
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::GetDeviceParam(USHORT usMode, INT nParam[12])
{
    THISMODULE(__FUNCTION__);
    AutoLogFuncBeginEnd();
    //AutoMutex(m_MutexAction);
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::GetDeviceFW(LPSTR lpDevFW, USHORT usLen)
{
    THISMODULE(__FUNCTION__);
    AutoLogFuncBeginEnd();
    //AutoMutex(m_MutexAction);
 ...
 * 返回值: 参考错误码(IMP_XXX)
************************************************************/
INT CDevImpl_ACTU6SG5::CmdSendRecv(LPCSTR lpcSndCmd, LPCSTR lpcSndData, INT nDataLen,
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::SendCmd(LPCSTR lpcCmd, LPCSTR lpcData, INT nLen, UINT uiTimeout, BOOL bSingle)
{
    THISMODULE(__FUNCTION__);
    //AutoLogFuncBeginEnd();
    //AutoMutex(m_MutexAction);
 ...
 * 返回：参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::GetResponse(LPSTR lpResponse, INT nLen, UINT uiTimeout, INT &nOutLen)
{
    Q_UNUSED(nLen)
 ...
 * 返回：BCC
************************************************************/
BYTE CDevImpl_ACTU6SG5::GetDataBCC(LPSTR lpData, USHORT usDataSize)
{
    if (lpData == nullptr)
    {
        return 0;
 ...
 * 返回值: 参考错误码
************************************************************/
INT CDevImpl_ACTU6SG5::RcvDataCheck(LPCSTR lpcSndCmd, LPCSTR lpcRcvData, INT &nRcvDataLen, BOOL bLog)
{
    THISMODULE(__FUNCTION__);
    //AutoLogFuncBeginEnd();
    //AutoMutex(m_MutexAction);
...
INT CDevImpl_ACTU6SG5::ConvertErrorCode(INT nRet)
{
    switch (nRet)
    {
...
// IMPL错误码解释
CHAR* CDevImpl_ACTU6SG5::ConvertErrCodeToStr(INT nRet)
{
...
// 下发命令码解释
CHAR* CDevImpl_ACTU6SG5::CmdToStr(LPSTR lpCmd)
{
