#ifndef DevCRD_ACTU6SG5_H
#define DevCRD_ACTU6SG5_H
...
#define LOG_NAME_DEVCRD     "DevCRD_ACTU6SG5.log"


//-------------------------------------------------------------------------------
class CDevCRD_ACTU6SG5 : public IDevCRD, public CLogManage
{
...
private:
    ...
    CDevImpl_ACTU6SG5             m_devACTU6SG5;
    //ST_CRD_ACTU6SG5_INIT_PARAM    m_stCRDACTU6SG5InitParam;
    CHAR                        m_szErrStr[1024];
    INT                         m_nParam[12];   // 机器参数
};

#endif // DevCRD_ACTU6SG5_H
