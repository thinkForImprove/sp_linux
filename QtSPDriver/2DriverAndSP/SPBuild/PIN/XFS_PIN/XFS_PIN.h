...
protected:
    ...
    bool FireSystemKbEvent(ULONG ulLFSKeyCode);
private:
 ...
 //30-00-00-00(FS#0003)  end
    ...
    int                               m_iRSARemoteImportSymmKeyType;   //RSA远程导入对称主密钥类型
    int                               m_iPinblockCustomerDataMode;
	bool                              m_bSystemKbEvtSupp;

    string                            m_strRSAKeyPairName;      //30-00-00-00(FS#0006)
    CVirtualKBEvent                   m_cVirtualKBEvent;
};
