...
#define NOTE_GETJSON2       "{\"UseJsonArea\": 0, \"FieldName\": \"CheckNo\" }"
...
//-----------------处理类 定义-------------------------
class CXFS_CPR : public ICmdFunc, public CTextPrinter, public ConvertVar
{
...
private:    // 格式转换相关
    ...
    WORD BoxNoteType2DevSDK(USHORT usNote, USHORT usDevMode);                       // 票据箱指定票据类型转换为设备接口专用类型
