...
typedef struct _tag_brm_config_param : public CLogManage
{
    ...
    BOOL GetPresentSPControlCloseShutter()          //30-00-00-00(FT#0005)
    {                                               //30-00-00-00(FT#0005)
        return bPresenSPCloseShutter;               //30-00-00-00(FT#0005)
    }                                               //30-00-00-00(FT#0005)

    WORD GetCashInStatusWhenCSNotEmpty()            //30-00-00-00(FT#0014)
    {                                               //30-00-00-00(FT#0014)
        return wCashInStatusWhenCsNotEmpty;          //30-00-00-00(FT#0014)
    }                                               //30-00-00-00(FT#0014)

    ULONG GetCassMiniGuarantee()
    {
        return ulCassMiniGuarantee;
    }

    //入金拒钞张数是否累加
    BOOL GetCashinRefuseCountAddFlag()             //30-00-00-00(FT#0034)
    {                                              //30-00-00-00(FT#0034)
        return bCashinRefuseCountAdd;              //30-00-00-00(FT#0034)
    }                                              //30-00-00-00(FT#0034)

    BOOL GetSetUnitInfoRelieveManipSupp()          //30-00-00-00(FT#0042)
    {                                              //30-00-00-00(FT#0042)
        return bSetUnitInfoRelieveManipSupp;       //30-00-00-00(FT#0042)
    }                                              //30-00-00-00(FT#0042)
    BOOL GetResetRelieveManipSupp()                //30-00-00-00(FT#0042)
    {                                              //30-00-00-00(FT#0042)
        return bResetRelieveManipSupp;             //30-00-00-00(FT#0042)
    }                                              //30-00-00-00(FT#0042)

    BOOL GetCashInBoxReturnNOITEMS()               //30-00-00-00(FT#0054)
    {                                              //30-00-00-00(FT#0054)
        return bCashInBoxReturnNOITEMS;            //30-00-00-00(FT#0054)
    }                                              //30-00-00-00(FT#0054)

    BOOL GetPresentTakenEventAfterCloseShutterFlag()
    {
        return bPresentTakenEventAfterCloseShutter;
    }

    BOOL GetShutterClosedErrorSupp(){
        return bShutterClosedErrorSupp;
    }

    BOOL GetShutterOpenedErrorSupp(){
        return bShutterOpenedErrorSupp;
    }
    ...
    _tag_brm_config_param()
    {
        ...
        ulCassMiniGuarantee = 0;
        bCashinRefuseCountAdd = TRUE;                   //30-00-00-00(FT#0034)
        bResetRelieveManipSupp = TRUE;                  //30-00-00-00(FT#0042)
        bSetUnitInfoRelieveManipSupp = TRUE;            //30-00-00-00(FT#0042)
        bCashInBoxReturnNOITEMS = FALSE;                //30-00-00-00(FT#0054)
        bPresentTakenEventAfterCloseShutter = FALSE;

        bShutterClosedErrorSupp = FALSE;
        bShutterOpenedErrorSupp = FALSE;
...
private:
    ...
    //Present命令SP控制关门
    BOOL bPresenSPCloseShutter;             //30-00-00-00(FT#0005)

    //钞口有钞时发送CashInEnd命令，存款状态值
    WORD wCashInStatusWhenCsNotEmpty;        //30-00-00-00(FT#0014)

    //存款拒钞张数是否累加
    BOOL bCashinRefuseCountAdd;             //30-00-00-00(FT#0034)
    ...
    ULONG ulCassMiniGuarantee;
    BOOL  bResetRelieveManipSupp;                           //30-00-00-00(FT#0042)
    BOOL  bSetUnitInfoRelieveManipSupp;                     //30-00-00-00(FT#0042)
    BOOL  bCashInBoxReturnNOITEMS;                          //30-00-00-00(FT#0054)
    //PRESENT命令门关闭后上报taken事件
    BOOL  bPresentTakenEventAfterCloseShutter;

    BOOL  bShutterClosedErrorSupp;
    BOOL  bShutterOpenedErrorSupp;
