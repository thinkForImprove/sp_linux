...
void CNoteTypeList::Copy(const WFSCIMNOTETYPELIST &src)
{
    ...
    USHORT usNumOfNoteTypesNew = src.usNumOfNoteTypes;      //30-00-00-00(FS#0021)
    for (USHORT i = 0; i < src.usNumOfNoteTypes; i++)
    {
        if(src.lppNoteTypes[i]->usNoteID == 128){           //30-00-00-00(FS#0021)
            usNumOfNoteTypesNew--;                          //30-00-00-00(FS#0021)
...
//30-00-00-00(FS#0021)    usNumOfNoteTypes = src.usNumOfNoteTypes;
    usNumOfNoteTypes = usNumOfNoteTypesNew;                 //30-00-00-00(FS#0021)
}
