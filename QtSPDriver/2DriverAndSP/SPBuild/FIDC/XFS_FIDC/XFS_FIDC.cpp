...
//        UpdateDevStatus(iRetStatus);
    ...
    if (fwMedia == WFS_IDC_MEDIANOTPRESENT &&
       (wLastMedia == WFS_IDC_MEDIAPRESENT ||wLastMedia == WFS_IDC_MEDIAENTERING || wLastMedia == WFS_IDC_MEDIAPRESENT))
    {
        //关闭非接灯
        ControlLED(0);
        m_ulTakeMonitorStartTime = 0;
