...
void *ControlSKMLampFlashHT(void *pDev){
...
//////////////////////////////////////////////////////////////////////////
CDevSIU_IOMC::CDevSIU_IOMC(LPCSTR lpDevType): m_cDev(lpDevType),
                                              m_cPWDev(lpDevType)
{
...
//        }
    ...
    //启动SKM灯闪烁处理线程
    lRet = pthread_create(&m_tid, NULL, ControlSKMLampFlashHT, this);
    if(lRet != 0){
