...
public:
    ...
    INT GetPrinterName(LPSTR pszName, WORD &wNameSize);
    INT ControlMedia(int nFeedLength);
    INT ControlMedia(BOOL bDetectBlackStripe, int nFeedLength);
    INT LineModePrintText(LPSTR lpPrintString, WORD wStringSize, WORD wStartX);
    INT LineModePrintImage(LPSTR lpImageStr, WORD lpImageStrSize, WORD wStartX);
    INT LineModePrintImageRAM(LPSTR lpImageStr, WORD lpImageStrSize, WORD wStartX);
    INT LineModePrintImageByMode(LPSTR lpImageStr, WORD lpImageStrSize, WORD wStartX);
