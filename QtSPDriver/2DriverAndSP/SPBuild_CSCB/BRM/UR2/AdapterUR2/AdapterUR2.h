...
typedef struct _wfs_cim_cash_in_limit
{
    ...
    AMOUNTLIMIT      lpAmountLimit;
} CIMCASHINLINITINF, *LPCIMCASHINLINITINF;
//test#27 end
...
private:
    ...
    //入金限额设定
    void vSetCimCashinLimit(ULONG ulTotalItemsLimit,ULONG ulAmount, LPCSTR lpCurrencyID);              //test#27
...
private:
    ...
    CIMCASHINLINITINF m_stCashInLimitInf;       //test#27
