...
static const char *ThisFile = "DevFIG_SM205.cpp";
//////////////////////////////////////////////////////////////////////////////
// 对外接口调用处理                                                            //
//////////////////////////////////////////////////////////////////////////////
CDevFIG_SM205BCT::CDevFIG_SM205BCT(LPCSTR lpDevType)
{
    m_nPort = 0;                                    // 端口号0=USB,1=串口1, 2=串口2, ...
...
{
    int nRet = 0;
    memcpy(stFprVersion.pszDevSN, m_pszDevSN, MAX_EXT);
...
int CDevFIG_SM205BCT::CollectFPData()
{
