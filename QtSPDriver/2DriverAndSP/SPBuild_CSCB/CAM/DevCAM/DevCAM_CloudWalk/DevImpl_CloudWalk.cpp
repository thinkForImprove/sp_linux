...
BOOL CDevImpl_CloudWalk::LoadCloudWalkIntf()
{
    ...
    cwEngineEnumResolutions = (pcwEngineEnumResolutions)m_CloudWalkLibrary.resolve("cwEngineEnumResolutions");
    FUNC_POINTER_ERROR_RETURN(cwEngineEnumResolutions, "cwEngineEnumResolutions");

    // 1.14 枚举相机支持的所有分辨率(VIDPID)
    cwEngineEnumResolutionsEx = (pcwEngineEnumResolutionsEx)m_CloudWalkLibrary.resolve("cwEngineEnumResolutionsEx");
    FUNC_POINTER_ERROR_RETURN(cwEngineEnumResolutionsEx, "cwEngineEnumResolutionsEx");
