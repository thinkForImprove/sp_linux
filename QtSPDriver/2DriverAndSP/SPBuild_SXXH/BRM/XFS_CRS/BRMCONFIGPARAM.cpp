...
int _tag_brm_config_param::LoadParam(LPCSTR lpszFileName)
{
	...
	bPresenSPCloseShutter = m_SPConfigFile.GetInt("BRMInfo", "PresentSPCloseShutter", 1) == 1;   				//40-00-00-00(FT#0005)
	bTakenEventAfterCloseShutter = m_SPConfigFile.GetInt("SPEC", "TakenEventAfterCloseShutter", 1) == 1;		//40-00-00-00(FT#0005)
    bEPDownAutoReset = (m_SPConfigFile.GetInt("BRMInfo", "EPDownAutoReset", 0) != 0);
    bRetractFromInShutterForReset = (m_SPConfigFile.GetInt("BRMInfo", "RetractFromInShutterForReset", 0) != 0);
    dwCashInEndCheckStatusTimeout = m_SPConfigFile.GetInt("BRMInfo", "CashInEndCheckStatusTimeout", 0);
    bCashInStatusCancelToUnknown = (m_SPConfigFile.GetInt("BRMInfo", "CashInStatusCancelToUnknown", 1) != 0);
    usCashInStatusNoteNumberListMode = (USHORT)m_SPConfigFile.GetInt("BRMInfo", "CashInStatusNoteNumberListMode", 0);
	...
	ulCassMiniGuarantee = m_SPConfigFile.GetInt("BRMInfo", "CassMiniGuarantee", 30);			//40-00-00-00(FS#0003)
    return 0;
}
