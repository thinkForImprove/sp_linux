...
typedef struct _tag_brm_config_param : public CLogManage
{
    ...
    //是否支持由ｓｐ控制出金口门: 1,长上高存默认支持；0，不支持
    BOOL IsCashOutShutterControlBySPOnly() const        //test#21
    {                                                   //test#21
        return bCashOutShutterControlBySPOnly;          //test#21
    }                                                   //test#21
    ...
    BOOL GetPresentSPControlCloseShutter()          //40-00-00-00(FT#0005)
    {                                               //40-00-00-00(FT#0005)
        return bPresenSPCloseShutter;               //40-00-00-00(FT#0005)
    }                                               //40-00-00-00(FT#0005)
    ULONG GetCassMiniGuarantee()					//40-00-00-00(FS#0003)
    {												//40-00-00-00(FS#0003)
        return ulCassMiniGuarantee;					//40-00-00-00(FS#0003)
    }												//40-00-00-00(FS#0003)
	BOOL GetTakenEventAfterCloseShutterFlag()		//40-00-00-00(FT#0005)
    {												//40-00-00-00(FT#0005)
        return bTakenEventAfterCloseShutter;		//40-00-00-00(FT#0005)
    }												//40-00-00-00(FT#0005)
    ...
    BOOL GetRetractFromInShutterForReset() const
    {
        return bRetractFromInShutterForReset;
    }
    DWORD GetCashInEndCheckStatusTimeout() const
    {
        return dwCashInEndCheckStatusTimeout;
    }
    BOOL GetCashInStatusCancelToUnknown() const
    {
        return bCashInStatusCancelToUnknown;
    }
    USHORT GetCashInStatusNoteNumberListMode() const
    {
        return usCashInStatusNoteNumberListMode;
    }
    ...
    _tag_brm_config_param()
    {
		...
		bPresenSPCloseShutter = TRUE;						//40-00-00-00(FT#0005)
		bTakenEventAfterCloseShutter = FALSE;				//40-00-00-00(FT#0005)
...
private:
    ...
    //Present命令SP控制关门
    BOOL bPresenSPCloseShutter;             //40-00-00-00(FT#0005)
	//PRESENT命令门关闭后上报taken事件
    BOOL bTakenEventAfterCloseShutter;		//40-00-00-00(FT#0005)
    ...
    ULONG ulCassMiniGuarantee;						//40-00-00-00(FS#0003)
    BOOL bCashOutShutterControlBySPOnly;  //test#21
    BOOL bEPDownAutoReset;
    BOOL bRetractFromInShutterForReset;
    DWORD dwCashInEndCheckStatusTimeout;
    BOOL bCashInStatusCancelToUnknown;
    USHORT usCashInStatusNoteNumberListMode;
