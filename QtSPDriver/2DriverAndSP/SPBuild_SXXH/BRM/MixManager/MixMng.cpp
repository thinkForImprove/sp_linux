                                    ...
                                    ULONG ulMaxDispenseCount)
{
    ...
    CUContainer.GenerateEqualEmptySafeCount();
    ...
    while (true)
    {
        ...
        ULONG ulTotalValuesOfMaxLeftCount = FindMaxLeftNumberIndex(CUContainer, lstIndex, ulSecondMaxLeftCount);
        assert(lstIndex.size() > 0);
