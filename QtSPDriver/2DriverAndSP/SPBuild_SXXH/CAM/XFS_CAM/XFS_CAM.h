...
#define DEVTYPE_CHG(a)  a == 0 ? IDEV_TYPE_CW1 : (a == 1 ? IDEV_TYPE_TCF1 : "")
...
private:    // 功能子处理
    ...
    HRESULT InnerDisplay(const WFSCAMDISP &stTakePict, DWORD dwTimeout);
    HRESULT InnerDisplayEx(const WFSCAMDISPEX &stDispEx, DWORD dwTimeout);
    HRESULT InneDisplayChg_CloudWalk(WORD &wWidth, WORD &wHeight, WORD wMode);
