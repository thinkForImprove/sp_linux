...
//        stFlickerSetData.Flk[IOMC_FLK_ID_LMP_CS] = byNewStatus;
    ...
    case GUIDLIGHT_FINGER:                                  // 指纹仪
        ...
        break;
    case GUIDLIGHT_RFCARDUNIT:
        return SetSKMLampCmd(wCmd, 3);
        break;
    case GUIDLIGHT_IDCARDREADER:
        stFlickerSetData.Flk[IOMC_FLK_ID_FL_CS] = byNewStatus;
        break;
    case GUIDLIGHT_TRACKCARDUNIT:                         // 磁条刷卡器
        return SetSKMLampCmd(wCmd, 3);
        break;
    case GUIDLIGHT_CODESCANNER:
    case GUIDLIGHT_HIGHCAMERA:
    case GUIDLIGHT_ICCARDUNIT:
    case GUIDLIGHT_KEYDISPENSER:
    case GUIDLIGHT_BUNDLEDISPENSE:
