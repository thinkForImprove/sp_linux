...
//40-00-00-00(FT#0015)        return ERR_UR_USB_CMD_ERR;
        return USBDrvError2DriverError(uRet);               //40-00-00-00(FT#0015)
    }
    return 0;
}
...
//40-00-00-00(FT#0015)        return USBDrvError2DriverError(static_cast<ULONG>(lRet));
        return lRet;                //40-00-00-00(FT#0015)
    }
