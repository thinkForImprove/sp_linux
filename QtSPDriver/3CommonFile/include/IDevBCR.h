...
struct st_Device_OpenMode
{
    ...
    CHAR    szDevPath[8][64+1]; // 设备路径或其他路径(可设置8组)
    WORD    wBaudRate[8];       // 设备串口波特率或其他整型参数(可设置8组)
    CHAR    szHidVid[8][32+1];  // 设备VID(可设置8组)
    CHAR    szHidPid[8][32+1];  // 设备PID(可设置8组)
    WORD    wProtocol;          // 通讯协议
