...
struct ICmdFunc
{
    ...
    virtual HRESULT CDMCount(LPWFSCDMPHYSICALCU lpPhysicalCU, LPWFSCDMCOUNT &lpCount) = 0;
    ...
    virtual HRESULT CDMOpenSafeDoor() = 0;
    ...
    virtual HRESULT CDMTestCashUnits(LPWFSCDMITEMPOSITION lpPosition, LPWFSCDMCUINFO &lpCUInfo) = 0;
    virtual HRESULT CDMSetGuidanceLight(LPWFSCDMSETGUIDLIGHT lpSetGuidLight) = 0;
    ...
    virtual HRESULT CIMOpenSafeDoor() = 0;
    ...
    virtual HRESULT CIMSetGuidanceLight(const LPWFSCIMSETGUIDLIGHT lpSetGuidLight) = 0;
...
extern "C" Q_DECL_EXPORT long CreateISPBaseCOR(LPCSTR lpDevType, ISPBaseCOR *&p);
//////////////////////////////////////////////////////////////////////////
