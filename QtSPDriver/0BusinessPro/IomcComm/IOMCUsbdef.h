...
enum EN_IOMC_CMD
{
    ...
    EN_IOMC_CMD_DISPLAY_CONTROL             = 0x0080,   // CMD[0x8000]
    EN_IOMC_CMD_FLICKER_CONTROL             = 0x0035,   // CMD[0x3500]
    EN_IOMC_CMD_GENERAL_IO                  = 0x00A3,   // CMD[0xA300]
    EN_IOMC_CMD_FIXED_KEY_INPUT_SET         = 0x0041,   // CMD[0x4100]
    ...
    EN_IOMC_CMD_POWER_RECV_FLAG_CLEAR       = 0x0010,   // CMD[0x1000]
    EN_IOMC_CMD_POWER_FAIL_RECV_FLAG_READ   = 0x0110,   // CMD[0x1001]
    EN_IOMC_CMD_TIMER_INFO_READ             = 0x0011,   // CMD[0x1100]
    EN_IOMC_CMD_TIMER_INFO_SET              = 0x0012,   // CMD[0x1200]
    EN_IOMC_CMD_TEMPERATURE_SENSER_READ     = 0x0013,   // CMD[0x1300]
    EN_IOMC_CMD_ENVIRONMENT_SENSER_READ     = 0x0024,   // CMD[0x2400]
    EN_IOMC_CMD_FH_SPL_STATUS_READ          = 0x0014,   // CMD[0x1400]
    EN_IOMC_CMD_USB_VBUS_CONTROL            = 0x0015,   // CMD[0x1500]
    EN_IOMC_CMD_UNIT_RESET                  = 0x0016,   // CMD[0x1600]
    EN_IOMC_CMD_UNIT_POWER_CONTROL          = 0x0017,   // CMD[0x1700]
    ...
    EN_IOMC_CMD_FLASH_WRITE                 = 0x001C,   // CMD[0x1C00]
    EN_IOMC_CMD_FLASH_CLEAR                 = 0x011C,   // CMD[0x1C01]
    EN_IOMC_CMD_FLASH_READ                  = 0x001D,   // CMD[0x1D00]
    EN_IOMC_CMD_START_SHUT_DOWN_NOTIFY      = 0x001F,   // CMD[0x1F00]
    EN_IOMC_CMD_START_REBOOT_NOTIFY         = 0x0021,   // CMD[0x2100]
    ...
    // -----------------------PowerUnit------------------------------
    EN_IOMC_CMD_AUTOPOWERON                 = 0x0090,   // CMD[0x9000]
    EN_IOMC_CMD_SCAN_TIME_SET               = 0x0012,   // CMD[0x1200]
    EN_IOMC_CMD_SCAN_REFRESH                = 0x0023,   // CMD[0x2300]
    EN_IOMC_CMD_BKLIGHT_ON                  = 0x00B3,   // CMD[0xB300]
    EN_IOMC_CMD_STOP_PW_SCAN                = 0x001E,   // CMD[0x1E00]
    EN_IOMC_CMD_PW_CONTROL                  = 0x0093,   // CMD[0x9300]
    EN_IOMC_CMD_PW_SCAN_FLAG                = 0x0022,   // CMD[0x2200]
    EN_IOMC_CMD_PW_CLEAR_FLAG               = 0x0010,   // CMD[0x1000]
    // PDL
