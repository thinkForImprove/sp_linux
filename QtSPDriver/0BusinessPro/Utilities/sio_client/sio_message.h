...
#include <cassert>
#include <type_traits>
#include "sio_client_global.h"

namespace sio
{
    class SIO_CLIENT_EXPORT message
    {
    public:
        enum flag
        {
    ...
    class SIO_CLIENT_EXPORT null_message : public message
    {
    protected:
        null_message()
            :message(flag_null)
    ...
    class SIO_CLIENT_EXPORT bool_message : public message
    {
        bool _v;
    ...
    class SIO_CLIENT_EXPORT int_message : public message
    {
        int64_t _v;
    protected:
    ...
    class SIO_CLIENT_EXPORT double_message : public message
    {
        double _v;
    ...
    class SIO_CLIENT_EXPORT string_message : public message
    {
        std::string _v;
    ...
    class SIO_CLIENT_EXPORT binary_message : public message
    {
    ...
    class SIO_CLIENT_EXPORT array_message : public message
    {
    ...
    class SIO_CLIENT_EXPORT object_message : public message
    {
    ...
    class SIO_CLIENT_EXPORT message::list
    {
    public:
        list()
        {
