...
} STPRINTFORMAT, *LPSTPRINTFORMAT1;
...
struct IDevPTR
{
    ...
    ************************************************************/
    ...
    /************************************************************
    ** 功能：打开与设备的连接
    ** 输入：usMode: 指定设备类型(0/HOTS;1SNBC BK-C310;2SNBC BT-NH80)
    ** 输出：无
    ** 返回：见返回错误码定义
    ************************************************************/
    virtual long OpenDev(const unsigned short usMode) = 0;
    ...
    ** 返回：见返回错误码定义
    ************************************************************/
    virtual long PrintImageOrg(const char* szImagePath, unsigned long ulOrgX, unsigned long ulOrgY) = 0;
    ...
    ** 返回：固件版本
    ************************************************************/
    virtual bool GetFWVersion(char *szFWVer, unsigned long *ulSize) = 0;
