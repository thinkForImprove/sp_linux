...
const BOOL bURJBSupp,                                       //30-00-00-00(FT#0040)
const BOOL bCountCorrectionSupp                             //30-00-00-00(FT#0040)
)
{
    ...
    if (bCountCorrectionSupp){                                  //30-00-00-00(FT#0040)
        bArrayOPInfo[2] |= 0x10;                                //30-00-00-00(FT#0040)
    }                                                           //30-00-00-00(FT#0040)
...
//			}
    ...
    // 16. Fixed number setting for unknown reject 可变包，如果配置项为空则不添加该数据包
    if (bCountCorrectionSupp)                                                           //30-00-00-00(FT#0040)
    {                                                                                   //30-00-00-00(FT#0040)
        memset(szCmdParam, 0, sizeof(szCmdParam));                                      //30-00-00-00(FT#0040)
        szCmdParam[0] = 0x05;                                                           //30-00-00-00(FT#0040)
        szCmdParam[1] = 0x2C;                                                           //30-00-00-00(FT#0040)
        szCmdParam[2] = 0x00;                                                           //30-00-00-00(FT#0040)
        szCmdParam[3] = 0x08;                                                           //30-00-00-00(FT#0040)
                                                                                        //30-00-00-00(FT#0040)
        char bArrayOPInfo[4] = {0};                                                     //30-00-00-00(FT#0040)
        bArrayOPInfo[0] |= 0x20;                                                        //30-00-00-00(FT#0040)
                                                                                        //30-00-00-00(FT#0040)
        memcpy(szCmdParam + 6, bArrayOPInfo, 4);                                        //30-00-00-00(FT#0040)
        memcpy(szCmdData + iCmdLen, szCmdParam, 10);                                    //30-00-00-00(FT#0040)
        iCmdLen += 10;                                                                  //30-00-00-00(FT#0040)
    }                                                                                   //30-00-00-00(FT#0040)
...
)
{
    ...
    if (iDataPos > 0)
    {
        ...
        if (szResp[iDataPos] & 0x02)
            stDispMissfeedRoom.bArryRoom[3] = TRUE;
