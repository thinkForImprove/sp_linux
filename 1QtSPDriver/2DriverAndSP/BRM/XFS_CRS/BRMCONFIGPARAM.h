...
typedef struct _tag_brm_config_param : public CLogManage
{
    ...
    //是否更改抄箱信息的最大值，0: 不更该，1: 更改            //30-00-00-00(FT#0004)
    BOOL IsSetUnitInfoIgnoreMax() const                 //30-00-00-00(FT#0004)
    {                                                   //30-00-00-00(FT#0004)
        return bSetUnitInfoIgnoreMax;                   //30-00-00-00(FT#0004)
    }                                                   //30-00-00-00(FT#0004)
	...
	//入金拒钞张数是否累加
    BOOL GetCashinRefuseCashCountAddFlag()
    {
        return bCashinRefuseCashCountAdd;
    }
    BOOL GetTakenEventAfterCloseShutterFlag()
    {
        return bTakenEventAfterCloseShutter;
    }
    ...
    _tag_brm_config_param()
    {
        ...
        bSetUnitInfoIgnoreMax = FALSE;                      //30-00-00-00(FT#0004)
...
private:
    ...
    //是否更改抄箱信息的最大值，0: 不更该，1: 更改             //30-00-00-00(FT#0004)
    BOOL  bSetUnitInfoIgnoreMax;                         //30-00-00-00(FT#0004)
    ...
    //存款拒钞张数是否累加
    BOOL bCashinRefuseCashCountAdd;

    //PRESENT命令门关闭后上报taken事件
    BOOL bTakenEventAfterCloseShutter;
