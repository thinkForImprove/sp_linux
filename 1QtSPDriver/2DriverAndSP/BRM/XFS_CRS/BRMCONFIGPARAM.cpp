...
int _tag_brm_config_param::LoadParam(LPCSTR lpszFileName)
{
    ...
    bSetUnitInfoIgnoreMax = m_SPConfigFile.GetInt("BRMInfo", "SetUnitInfoIgnoreMax", 0);        //30-00-00-00(FT#0004)
    ...
    bCashinRefuseCashCountAdd = m_SPConfigFile.GetInt("BRMInfo", "CashinRefuseCashCountAdd", 0) == 1;
    bTakenEventAfterCloseShutter = m_SPConfigFile.GetInt("SPEC", "TakenEventAfterCloseShutter", 0) == 1;
