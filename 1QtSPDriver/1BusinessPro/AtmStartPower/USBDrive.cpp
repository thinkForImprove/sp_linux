...
LPCSTR CUSBDrive::GetErrDesc(ULONG ulErrCode)
{
    ...
    switch (ulErrCode)
    {
    case ERR_DRV_USB_CANCEL_END:
        strcpy(m_szDesc, "ERR_DRV_USB_CANCEL_END");
        break;
    case ERR_DRV_USB_CANCEL_NOPST:
        strcpy(m_szDesc, "ERR_DRV_USB_CANCEL_NOPST");
        break;
    case ERR_DRV_USB_CANCEL_CROSS_END:
        strcpy(m_szDesc, "ERR_DRV_USB_CANCEL_CROSS_END");
        break;
    case ERR_DRV_USB_CANCEL_NOTHING:
        strcpy(m_szDesc, "ERR_DRV_USB_CANCEL_NOTHING");
        break;
    case ERR_DRV_USB_FUNC:
        strcpy(m_szDesc, "ERR_DRV_USB_FUNC");
        break;
    case ERR_DRV_USB_PRM:
        strcpy(m_szDesc, "ERR_DRV_USB_PRM");
        break;
    case ERR_DRV_USB_DRVHND_DIFFER:
        strcpy(m_szDesc, "ERR_DRV_USB_DRVHND_DIFFER");
        break;
    case ERR_DRV_USB_DRV_REMOVE:
        strcpy(m_szDesc, "ERR_DRV_USB_DRV_REMOVE");
        break;
    case ERR_DRV_USB_BLD:
        strcpy(m_szDesc, "ERR_DRV_USB_BLD");
        break;
    case ERR_DRV_USB_INDATA:
        strcpy(m_szDesc, "ERR_DRV_USB_INDATA");
        break;
    case ERR_DRV_USB_OUTDATA:
        strcpy(m_szDesc, "ERR_DRV_USB_OUTDATA");
        break;
    case ERR_DRV_USB_INOUTDATA:
        strcpy(m_szDesc, "ERR_DRV_USB_INOUTDATA");
        break;
    case ERR_DRV_USB_ENTRY_DEVICE_OVER:
        strcpy(m_szDesc, "ERR_DRV_USB_ENTRY_DEVICE_OVER");
        break;
    case ERR_DRV_USB_ENTRY_THREAD_OVER:
        strcpy(m_szDesc, "ERR_DRV_USB_ENTRY_THREAD_OVER");
        break;
    case ERR_DRV_USB_BCC:
        strcpy(m_szDesc, "ERR_DRV_USB_BCC");
        break;
    case ERR_DRV_USB_INDATA_BUFFSZ:
        strcpy(m_szDesc, "ERR_DRV_USB_INDATA_BUFFSZ");
        break;
    case ERR_DRV_USB_OUTDATA_BUFFSZ:
        strcpy(m_szDesc, "ERR_DRV_USB_OUTDATA_BUFFSZ");
        break;
    case ERR_DRV_USB_INOUTDATA_BUFFSZ:
        strcpy(m_szDesc, "ERR_DRV_USB_INOUTDATA_BUFFSZ");
        break;
    case ERR_DRV_USB_LINE_TIMEOUT:
        strcpy(m_szDesc, "ERR_DRV_USB_LINE_TIMEOUT");
        break;
    case ERR_DRV_USB_COMMAND_TIMEOUT:
        strcpy(m_szDesc, "ERR_DRV_USB_COMMAND_TIMEOUT");
        break;
    case ERR_DRV_USB_CLOSE:
        strcpy(m_szDesc, "ERR_DRV_USB_CLOSE");
        break;
    case ERR_DRV_USB_OPEN_BUSY:
        strcpy(m_szDesc, "ERR_DRV_USB_OPEN_BUSY");
        break;
    case ERR_DRV_USB_SEND_BUSY:
        strcpy(m_szDesc, "ERR_DRV_USB_SEND_BUSY");
        break;
    case ERR_DRV_USB_RCV_BUSY:
        strcpy(m_szDesc, "ERR_DRV_USB_RCV_BUSY");
        break;
    case ERR_DRV_USB_EP_DOWN:
        strcpy(m_szDesc, "ERR_DRV_USB_EP_DOWN");
        break;
    case ERR_DRV_USB_MEMORY:
        strcpy(m_szDesc, "ERR_DRV_USB_MEMORY");
        break;
    case ERR_DRV_USB_HANDLE:
        strcpy(m_szDesc, "ERR_DRV_USB_HANDLE");
        break;
    case ERR_DRV_USB_REG:
        strcpy(m_szDesc, "ERR_DRV_USB_REG");
        break;
    case ERR_DRV_USB_DRVCALL:
        strcpy(m_szDesc, "ERR_DRV_USB_DRVCALL");
        break;
    case ERR_DRV_USB_THREAD:
        strcpy(m_szDesc, "ERR_DRV_USB_THREAD");
        break;
    case ERR_DRV_USB_POSTMSG:
        strcpy(m_szDesc, "ERR_DRV_USB_POSTMSG");
        break;
    case ERR_DRV_USB_TRACE:
        strcpy(m_szDesc, "ERR_DRV_USB_TRACE");
        break;
    default:
        sprintf(m_szDesc, "0x%08.08X", ulErrCode);
        break;
    }
    return m_szDesc;
}
