...
#define CASE_SET_HW_DETAIL(IMP, DEVID) \
    ...
    switch(nRet)
    {
        ...
        CASE_SET_DEV_DETAIL(IMP_ERR_DEVICE_NOTFOUND, EC_ERR_DevNotFound)    // 设备未找到
        CASE_SET_DEV_DETAIL(IMP_ERR_VIDPID_NOTFOUND, EC_ERR_DevNotFound)    // VID/PID未找到
        CASE_SET_DEV_DETAIL(IMP_ERR_VIDEOIDX_NOTFOUND, EC_ERR_DevNotFound)  // 未找到摄像设备索引号
        CASE_SET_DEV_DETAIL(IMP_ERR_DEVICE_OPENFAIL, EC_ERR_DevOpenFail)    // 设备打开失败/未打开
        CASE_SET_DEV_DETAIL(IMP_ERR_DEVICE_OFFLINE, EC_ERR_DevOffLine)      // 设备断线
