...
/***************************************************************************
// 返回值/错误码　宏定义 (通用定义, 见DevImpl_DEF.h)
***************************************************************************/
// 设备返回错误码(设备SDK返回为负数, 取为整数)
#define IMP_ERR_DEV_SUCCESS             0 - FR_RET_SUCC    // 执行成功
#define IMP_ERR_DEV_RUNFAIL             0 - FR_RET_FAIL    // 执行失败
#define IMP_ERR_DEV_PARAM               0 - FR_RET_PARA    // 参数错误
#define IMP_ERR_DEV_OPENFAIL            0 - FR_RET_NDEV    // 打开设备失败
#define IMP_ERR_DEV_NOTOPEN             0 - FR_RET_NINI    // 未打开设备
#define IMP_ERR_DEV_BUSY                0 - FR_RET_BUSY    // 设备繁忙
#define IMP_ERR_DEV_DATA                0 - FR_RET_DATA    // 图像数据不正确
#define IMP_ERR_DEV_OFFLINE             0 - FR_RET_NLNK    // 设备断开
#define IMP_ERR_DEV_LOADDLL             0 - FR_RET_NDRV    // 加载设备库失败
#define IMP_ERR_DEV_LOADALGO            0 - FR_RET_NALG    // 加载算法库失败
#define IMP_ERR_DEV_MEMORY              0 - FR_RET_NMEM    // 内存分配失败
#define IMP_ERR_DEV_ISOPEN              0 - FR_RET_ARDY    // 已经打开设备
#define IMP_ERR_DEV_AUTH                0 - FR_RET_AUTH    // 算法授权失败
#define IMP_ERR_DEV_IPC                 0 - FP_RET_IPCF    // IPC错误
