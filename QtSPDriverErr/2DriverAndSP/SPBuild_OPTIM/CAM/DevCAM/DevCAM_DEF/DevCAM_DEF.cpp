...
#define CASE_SET_DEV_DETAIL(IMP, STR) \
    ...
    switch(nRet)
    {
        CASE_SET_DEV_DETAIL(IMP_ERR_LOAD_LIB, EC_ERR_LibraryLoadFail)       // 动态库加载错误
        ...
        CASE_SET_DEV_DETAIL(IMP_ERR_NOTOPEN, EC_ERR_DevOffLine)             // 设备未Open
        CASE_SET_DEV_DETAIL(IMP_ERR_OPENFAIL, EC_ERR_DevOpenFail)           // 设备打开失败/未打开
        CASE_SET_DEV_DETAIL(IMP_ERR_NODEVICE, EC_ERR_DevNotFound)           // 未找到有效设备
        CASE_SET_DEV_DETAIL(IMP_ERR_OFFLINE, EC_ERR_DevOffLine)             // 设备断线
        CASE_SET_DEV_DETAIL(IMP_ERR_NODETECT, EC_CAM_DEV_NotLiveDetect)     // 未检测到活体
        CASE_SET_DEV_DETAIL(IMP_ERR_INTEREXEC, EC_ERR_InTerExec)            // 接口执行错误
        CASE_SET_DEV_DETAIL(IMP_ERR_SET_VMODE, EC_ERR_OtherErr)             // 摄像参数设置错误
        CASE_SET_DEV_DETAIL(IMP_ERR_SET_RESO, EC_ERR_OtherErr)              // 分辨率设置失败
        CASE_SET_DEV_DETAIL(IMP_ERR_SHAREDMEM_RW, EC_ERR_ShareMemRW)        // 共享内存读写失败
        CASE_SET_DEV_DETAIL(IMP_ERR_MEMORY, EC_ERR_MemoryErrr)              // 内存错误
    }
