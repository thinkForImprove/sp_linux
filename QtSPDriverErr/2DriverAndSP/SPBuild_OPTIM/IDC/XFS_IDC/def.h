...
***************************************************************************/
// CRM设备类型
#define XFS_CRM_CRT730B                 1                   // 退卡模块:CRT-730B(创自)
#define XFS_cRM_ZDCRM01                 2                   // 退卡模块:ZDCRM01(中电)

// CRM设备类型(DevCRM.cpp区分不同类型使用)
#define IDEV_CRM_CRT730B_STR            "CRT-730B"          // 退卡模块:CRT-730B
#define IDEV_CRM_ZDCRM01_STR            "ZDCRM01"           // 退卡模块:CRT-730B

// INI中指定[int型]设备类型 转换为 STR型
#define CRM_DEVTYPE2STR(n) \
    (n == XFS_CRM_CRT730B ? IDEV_CRM_CRT730B_STR : "")
...
struct st_crm_ini_config
{
    ...
    WORD                wCRMDeviceType;                     // 退卡模块设备类型,缺省1(CRT-730B)
    STDEVICEOPENMODE    stDevOpenMode;                      // 设备打开模式
