...
#define IMP_ERR_STAT_POS_FAIL       -9906           // 状态返回暂存仓位置异常
#define IMP_ERR_STAT_INVALID        -9907           // 状态返回无效值
#define IMP_ERR_SLOTNO_INVALID      -9908           // 指定暂存仓编号无效
#define IMP_ERR_UNKNOWN             -9909           // 未知错误
#define IMP_ERR_SNDDATA_INVALID     -9900           // 无效的下发数据
...
#define IMP_ERR_DEVRET_02           2 + 1           // 命令数据错误
#define IMP_ERR_DEVRET_03           3 + 1           // 命令无法执行
#define IMP_ERR_DEVRET_06           6 + 1           // 维护门已经开启（此时不能发送动作指令!）
#define IMP_ERR_DEVRET_11           11 + 1          // 电源电压过低(低于20V)
#define IMP_ERR_DEVRET_12           12 + 1          // 电源电压过高(高于28V)
#define IMP_ERR_DEVRET_13           13 + 1          // 电源恢复正常但没有重新初始化
#define IMP_ERR_DEVRET_16           16 + 1          // 模块内部FRAM错误
#define IMP_ERR_DEVRET_19           19 + 1          // 暂存仓传感器错误
#define IMP_ERR_DEVRET_20           20 + 1          // 升降暂存仓阻塞
#define IMP_ERR_DEVRET_22           22 + 1          // 进卡阻塞
#define IMP_ERR_DEVRET_23           23 + 1          // 等待进卡超时
#define IMP_ERR_DEVRET_24           24 + 1          // 进卡时卡被拔走
#define IMP_ERR_DEVRET_28           28 + 1          // 退卡堵塞
#define IMP_ERR_DEVRET_29           29 + 1          // 电机定位堵塞
#define IMP_ERR_DEVRET_30           30 + 1          // 暂存仓未对准进卡口
#define IMP_ERR_DEVRET_31           31 + 1          // 目标暂存仓有卡
#define IMP_ERR_DEVRET_32           32 + 1          // 目标暂存仓无卡
#define IMP_ERR_DEVRET_35           35 + 1          // 卡片信息未保存
...
private:
    ...
    BOOL                            m_bDevOpenOk;
    DWORD                           m_dwSndTimeOut;                 // 命令下发超时时间
    DWORD                           m_dwRcvTimeOut;                 // 命令接收超时时间
