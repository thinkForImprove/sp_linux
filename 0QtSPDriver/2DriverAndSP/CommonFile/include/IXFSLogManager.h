...
struct IXFSLogManager
{
    ...
    virtual HRESULT LOGOpen(HSERVICE service, LPSTR logical_name, HAPP app_handle, LPSTR app_id, DWORD trace_level, DWORD timeout, LPSTR object_name,
                                 REQUESTID req_id, HPROVIDER provider, DWORD spi_versions_required, LPWFSVERSION spi_version, DWORD srvc_versions_required,
                                 LPWFSVERSION srvc_version, long result) = 0;
#else
