...
enum DENOMINATION_CODE
{
    ...
    DENOMINATION_CODE_10_4TH = 1,    // 第4版10元
    DENOMINATION_CODE_50_4TH = 2,
    DENOMINATION_CODE_100_4TH = 3,
    DENOMINATION_CODE_100_5TH = 4,
    DENOMINATION_CODE_20_5TH = 5,
    DENOMINATION_CODE_10_5TH = 6,    // 第5版10元
    DENOMINATION_CODE_50_5TH = 7,
    DENOMINATION_CODE_1_5TH = 8,
    DENOMINATION_CODE_5_5TH = 9,
    DENOMINATION_CODE_100_1999 = 0x0A,
    DENOMINATION_CODE_100_2015 = 0x0B,
    DENOMINATION_CODE_ALL = 0xFF        // 所有面额(该值只适应于存款箱)
};
...
public:
    ...
    virtual int SetUnitInfo(int iTotalCashInURJB,
                            ...
                            const char usArryCassCashOutPrioritySet[MAX_CASSETTE_NUM]) = 0;
