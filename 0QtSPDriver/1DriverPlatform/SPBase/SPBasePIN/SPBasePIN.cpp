...
//            _auto.push_back(lpNewKey);
//            memcpy(lpNewKey, lppKeyDetail[i], sizeof(WFSPINKEYDETAILEX));
...
//    HRESULT hRet = WFS_ERR_INTERNAL_ERROR;
    ...
    do
    {
        ...
        _auto.push_back(lpNewData);
        memcpy(lpNewData, lpStartkeyExg, sizeof(WFSPINSTARTKEYEXCHANGE));
...
//    HRESULT hRet = WFS_ERR_INTERNAL_ERROR;
    ...
    do
    {
        ...
        _auto.push_back(lpNewData);
        memcpy(lpNewData, lpOut, sizeof(WFSPINEXPORTRSAEPPSIGNEDITEMOUTPUT));
        if (lpOut->lpxValue != nullptr)
        {
            LPWFSXDATA lpNewXData = nullptr;
